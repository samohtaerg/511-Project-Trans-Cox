# -*- coding: utf-8 -*-
"""TransCox Setting 1 Plotting

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EIeaEPR2XunibND6B0WrR_HNMhNkGo59
"""

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
TransCox Setting 1 - High Quality Boxplot Generation
...
def prepare_boxplot_data(df, metric_name, true_value=None):
    ...
    if metric_name == 'beta1':
        ...
        title = f'Comparison of Beta1 Estimates (Setting 1, n={n_iterations})'
    elif metric_name == 'beta2':
        data_cols = ['aux_beta2', 'cox_beta2', 'pooled_beta2', 'transcox_beta2']
        ylabel = 'Beta2 Estimate'
        title = f'Comparison of Beta2 Estimates (Setting 1, n={n_iterations})'
    elif metric_name == 'mse':
        data_cols = ['aux_mse', 'cox_mse', 'pooled_mse', 'transcox_mse']
        ylabel = 'Mean Squared Error (MSE)'
        title = f'Comparison of Mean Squared Error (Setting 1, n={n_iterations})'
    else:
